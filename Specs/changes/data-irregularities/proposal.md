...
Proactively detect upstream data changes (like the Jan 2026 sauna name change) before they break the pipeline. This complements [`facility-name-aliases`](../facility-name-aliases/proposal.md) which handles known changes via `facility_aliases.json` - this spec catches **unknown** changes early.
